...
public class 加計算器 extends 計算器基本 implements 計算器 {
	...
	public String 個別計算_根据計算項目List(List<String> paramList) {
		...
		return Double.parseDouble(paramList.get(0)) + Double.parseDouble(paramList.get(1)) + "";
	}
	...
	public String 個別計算_根据計算項目List(Map map) {
		...
		return Double.parseDouble((String) map.get(0)) + Double.parseDouble((String) map.get(1)) + "";
	}
